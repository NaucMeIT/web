define("./workbox-adbd2882.js", ["exports"], function (t) {
    "use strict"
    try {
        ...
        async getCacheKey(t, e) {
            if (!this.h[e]) {
                ...
                for (const t of this.iterateCallbacks("cacheKeyWillBeUsed"))
                    s = m(await t({ mode: e, request: s, event: this.event, params: this.params }))
                this.h[e] = s
            }
            return this.h[e]
        }
    ...
    function k(t) {
        return t !== IDBDatabase.prototype.transaction || "objectStoreNames" in IDBTransaction.prototype
            ...
            : function (e, ...s) {
                  ...
                  return I.set(n, e.sort ? e.sort() : [e]), T(n)
              }
    }
    function O(t) {
    ...
    class F {
        ...
        async expireEntries() {
            if (this.N) return void (this.k = !0)
            this.N = !0
            ...
            ;(this.N = !1), this.k && ((this.k = !1), b(this.expireEntries()))
        }
