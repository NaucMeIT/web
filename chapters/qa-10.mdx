...
Začneme jednodušším view modem, který složí jen k prohlížení. Pole nelze upravovat. Takže se nabízí testovací scénář: zkus něco napsat do pole ve view modu.
