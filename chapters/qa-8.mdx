...
Ve videích je zmíněný SSH klíč. Doporučujeme si ho nastavit. Zaprvé s tím vytvoříš větší důvěru v tvé commity a za druhé nebudeš muset zadávat při každém commitu heslo. Pokud bys s tím bojoval, zeptej se na [Discordu](https://discord.gg/QbYswwYUPU).
...
Pokud bys chtěl skutečně proniknout do tajů Gitu, existuje téměř kompletně přeložená kniha o Gitu, plně dostupná online. Slouží jako dokumentace Gitu a do budoucna vám může být velmi užitečná. Naleznete ji na oficiálních [stránkách Gitu](https://git-scm.com/book/cs/v2). Nebojte se však pročítat ji jen tak, tyto znalosti se vám určitě budou hodit, ať už bude systém v práci jakýkoliv. Díky CZ.NIC je plně přeložená kniha [Pro Git](https://knihy.nic.cz/files/edice/pro_git.pdf)! Vyšlo již nové vydání, to je prozatím pouze v angličtině.

Na GitHubu Michala Hucka z Informatiky s Misom můžeš najít jednoduchý [cheat sheet](https://github.com/misohu/git-tutorial/blob/main/git-commands/commands.md) s příkazy. Pokud si chceš zopakovat výše uvedené informace v jedné přednášce podívej se na video od [yablka](https://www.youtube.com/watch?v=0v5K4GvK4Gs). Chceš být pořádný pařmen a nevadí ti angličtina? Vrhni se na [Oh My Git](https://ohmygit.org/), což je počítačová hra vysvětlující Git včetně mnoha tajemných zákoutí!

## Sloučení kódu a code review

Jakmile má vývojář svou práci hotovou je potřeba změny sloučit. K tomu slouží **Pull Request**, díky kterému dojde ke sloučení. Ale ne jen tak. Tady se liší postup firma od firmy a občas projekt od projektu.
...
7. Zveřejni své stránky:
       1. Otevři svůj repozitář na webové stránce GitHub a přejděte na záložku "Settings" (Nastavení).
...
2. Abychom si procvičili znalosti Gitu, je zde i soubor preLog, kam je potřeba uvést hash předchozího commitu. Popisek je opět v README.md.
