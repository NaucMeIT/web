...
Ve videích je zmíněný SSH klíč. Doporučujeme si ho nastavit. Zaprvé si tím vytvoříš větší důvěru ve své commity a za druhé nebudeš muset zadávat při každém commitu heslo. Pokud bys s tím bojoval, zeptej se na [Discordu](https://discord.gg/QbYswwYUPU).
...
7. Zveřejni své stránky:
    a. Otevři svůj repozitář na webové stránce GitHub a přejdi na záložku "Settings" (Nastavení).
    b. V sekci "Pages" (Stránky GitHub) zvol výchozí větev pro tvé stránky a klikni na tlačítko "Save" (Uložit).
    c. Ve výchozí větvi tvého repozitáře (nejčastěji "master" nebo "main") již nejspíš máš soubor "index.html" s obsahem tvých stránek. Pokud ne, úvodní strana by se tak měla jmenovat.
    d. Přidej, commitni a pushni změny do tvého repozitáře na GitHubu pomocí příkazů git add, git commit a git push.
    e. Po chvíli by se měly stránky zobrazit na adrese: https://&lt;tve_jmeno>.github.io/&lt;jmeno_repozitare>.
