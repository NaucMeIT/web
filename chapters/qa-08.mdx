...
7. Zveřejni své stránky:<br />
    a. Otevři svůj repozitář na webové stránce GitHub a přejdi na záložku "Settings" (Nastavení).<br />
    b. V sekci "Pages" (Stránky GitHub) zvol výchozí větev pro tvé stránky a klikni na tlačítko "Save" (Uložit).<br />
    c. Ve výchozí větvi tvého repozitáře (nejčastěji "master" nebo "main") již nejspíš máš soubor "index.html" s obsahem tvých stránek. Pokud ne, úvodní strana by se tak měla jmenovat.<br />
    d. Přidej, commitni a pushni změny do tvého repozitáře na GitHubu pomocí příkazů git add, git commit a git push.<br />
