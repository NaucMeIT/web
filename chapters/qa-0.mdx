...
Pro správné pochopení toho, kdo je to tester, si musíme na začátek vysvětlit něco málo z širší teorie a s tím souvisí několik pojmů.
...
Vyvinout software v dostatečné kvalitě, která uspokojí valnou většinu uživatelů je náročné. Zabývá se tím odvětví informatiky zvané [softwarové inženýrství](https://cs.wikipedia.org/wiki/Softwarov%C3%A9_in%C5%BEen%C3%BDrstv%C3%AD). Proces vývoje softwaru rozhodně není jednotný. Existuje mnoho způsobů, jak k vývoji přistupovat, některé si můžeš prohlédnout například na [Wikipedii](https://cs.wikipedia.org/wiki/Proces_v%C3%BDvoje_softwaru), my si to vysvětlíme velmi zjednodušeně.
...
Pokud stále tápeš, kdo je tester můžeš se podívat na záznam webináře: [Co je testování softwaru](https://kitner.cz/testovani_softwaru/co-je-testovani-softwaru) od Radka Kitnera.
...
A v případě takové chyby se nemusíme nutně bavit jen o financích.
