...
1. Otevři prohlížeč a klikni na tlačítko tři tečky vpravo nahoře. V menu Nápovědy bys měl najít položku „O prohlížeči“ (About browser, About <jméno prohlížeče>) nebo „O aplikaci“. Po kliknutí by se měla zobrazit informace o verzi prohlížeče.če.
