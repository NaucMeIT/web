...
1. Otevři prohlížeč a klikni na tlačítko tři tečky vpravo nahoře. V menu Nápovědy bys měl najít položku "O prohlížeči" (About browser, About &lt;jméno prohlížeče>) nebo "O aplikaci". Po kliknutí by se měla zobrazit informace o verzi prohlížeče.
...
Tab Sources (Zdroje) umožňuje zobrazit a upravovat zdrojové kódy stránek, které prohlížíš. Tento tab obsahuje několik nástrojů a funkcí, které pomáhájí analyzovat a ladit stránky.
