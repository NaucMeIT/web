...
export const PathList: React.FC = () => (
    <section className='overflow-hidden'>
        <article className='flex flex-col justify-center items-center bg-green-off px-[10vw] py-10'>
            <h2 className='z-10 self-start ml-0 text-lg-fluid'>Tester</h2>
            <p className='z-10 pt-5 mx-auto my-0 text-md-fluid text-blue-off'>
        ...
        <article className='flex flex-col justify-start items-center bg-blue-main px-[10vw] py-10'>
            <h2 className='z-10 self-start ml-0 text-lg-fluid'>Programátor</h2>
