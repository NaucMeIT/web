	...
	return (
		<section className='pt-20'>
			...
			<CourseBox image='/images/qa_illustration.svg' width={320} height={291} side='right' title='Tester'>
				Práce testera je ověřování kvality produktu. Na&nbsp;nalezené chyby upozorňuje srozumitelnou formou. Práce
				testera není příliš složitá. Vše potřebné se naučíš v našem kurzu.
			</CourseBox>
			<CourseBox image='/images/dev_illustration.svg' width={320} height={348} side='left' title='Programátor'>
				...
				<p>
					U nás se naučíš tvořit webové aplikace. Pod tím si můžeš představit třeba Gmail nebo Facebook. Samozřejmě
					nebudeš hned tvořit tak velké věci, ale začneš u menších projektů.
				</p>
			</CourseBox>
		</section>
	)
