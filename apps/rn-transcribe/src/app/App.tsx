      ...
      >
        ...
        >
          <View style={styles.section}>
            ...
            <Text style={[styles.textXL, styles.appTitleText]} testID='heading' role='heading' aria-level="1">
              Welcome RnTranscribe 👋
            </Text>
          </View>
          <View style={styles.section}>
            <View style={styles.hero}>
              <View style={styles.heroTitle}>
                ...
                <Text style={[styles.textLg, styles.heroTitleText]}>You are up and running</Text>
              </View>
              <TouchableOpacity
              ...
              >
                <Text style={[styles.textMd, styles.textCenter]}>What is next?</Text>
              </TouchableOpacity>
            </View>
          </View>
          <View style={styles.section}>
            <View style={[styles.shadowBox]}>
              ...
              <TouchableOpacity
                style={[styles.listItem, styles.learning]}
                onPress={() => Linking.openURL('https://nx.dev/nx-api/expo/documents/overview')}
              >
                <Svg width={24} height={24} stroke='#000000' fill='none' viewBox='0 0 24 24'>
                  <Path
                    strokeLinecap='round'
          ...
          <View style={styles.section}>
            <TouchableOpacity onPress={() => Linking.openURL('https://nx.dev/nx-cloud?utm_source=nx-project')}>
          ...
          <View style={styles.section}>
            <View style={styles.shadowBox}>
              <View style={[styles.listItem, styles.learning]}>
                <Svg width={48} height={48} role='img' stroke='currentColor' fill='transparent' viewBox='0 0 24 24'>
                  <Path
                    strokeWidth='2'
              ...
              <View style={styles.listItemTextContainer}>
                <Text style={[styles.textXS, styles.textLight]}>Your workspace is connected to Nx Cloud.</Text>
              </View>
              <TouchableOpacity
                style={styles.connectToCloudButton}
                onPress={() => {
                  Linking.openURL('https://nx.dev/ci/intro/ci-with-nx#learn-about-nx-on-ci')
                }}
              >
          ...
          >
            <View style={styles.shadowBox}>
              ...
              <View style={styles.codeBlock}>
                ...
                <Text style={[styles.textXS, styles.monospace, styles.marginBottomMd]}>nx build RnTranscribe</Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}># Test</Text>
                <Text style={[styles.textXS, styles.monospace, styles.marginBottomMd]}>nx test RnTranscribe</Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}># Lint</Text>
                <Text style={[styles.textXS, styles.monospace]}>nx lint RnTranscribe</Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}># Run them together!</Text>
                <Text style={[styles.textXS, styles.monospace, styles.marginBottomMd]}>
                  nx run-many -p RnTranscribe -t build test lint
                </Text>
              </View>
              ...
              <View style={[styles.codeBlock, styles.marginBottomLg]}>
                <Text style={[styles.textXS, styles.monospace]}>nx show project RnTranscribe</Text>
              </View>
              <View style={styles.listItem}>
                <Svg width={24} height={24} stroke='#000000' fill='none' viewBox='0 0 24 24'>
                  <Path
